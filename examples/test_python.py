...
def main():
    ...
    # 3. Target C++ byte sequence for verification (Now 25-bytes including Version=2, Flags=0, Timestamp=0)
    target_bytes = bytes([0xed, 0x02, 0x00, 0x10, 0xff, 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x0b, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x20, 0x4c, 0x6f, 0x52, 0x61, 0x21, 0xc6, 0x73])
